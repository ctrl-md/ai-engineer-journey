...
if __name__ == "__main__":
    ...
    w1, b1 = train(x=3, y=1, starting_w=0.5, starting_b=0.5, learning_rate=0.1, epochs=1000)
    print(f"[y=1 case] predicted probability: {predict(3, w1, b1):.6f}")

    # actual answer is "no" (y=0)
    w2, b2 = train(x=3, y=0, starting_w=0.5, starting_b=0.5, learning_rate=0.1, epochs=1000)
